...
namespace Mantenimientos.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EstudiantesID,Nombre,Apellido,Matricula")] Estudiantes estudiantes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EstudiantesID,Nombre,Apellido,Matricula")] Estudiantes estudiantes)
        {
